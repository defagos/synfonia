...
rem *************************************************************************
rem Visual Studio 2010 32-bit (out-of-source) solution generator for Synfonia
rem *************************************************************************
...
echo.------------------------------------------------
mkdir "%SYNFONIA_DEV_DIR%\MSVC10x86"
cd "%SYNFONIA_DEV_DIR%\MSVC10x86"
cmake -G "Visual Studio 10" "%SYNFONIA_ROOT_DIR%"
